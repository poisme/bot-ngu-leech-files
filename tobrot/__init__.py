...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5160376128:AAFCkyYMawhcD1dwWoq2RsoIGlJgNwd9gUg")
APP_ID = int(os.environ.get("APP_ID", "9318989"))
API_HASH = os.environ.get("API_HASH")
OWNER_ID = int(os.environ.get("OWNER_ID", "1651114672"))

# Get these values from my.telegram.org
# to store the channel ID who are authorized to use the bot
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001727575889").split()]
